...
.factory('WeekTrack', function() {
    var weeks = {
            ...
            '5': {
                motherText: 'Dear mom, you might have started noticing a few pregnancy related symptoms: morning sickness (or nausea which can happen at any time of the day), sore breasts, fatigue and frequent urination. Another symptom would be frequent mood swings. You may feel happy one moment and sad the next. I want to let you know that these changes are common. But be careful, mom. Too much stress can lead to depression. If you ever feel too low for a long period of time and you are unable to recover, promise me that you’ll seek help from our doctor.',
                babyText: 'Mom, I am still a small embryo but have grown to a size of a sesame seed. If you could peek inside, you will see that I look like a tadpole☺. Most of my critical organs have formed, including my heart. I am covered by three distinct layers: the ectoderm (forms the nervous system, ears, eyes, inner ear and many connective tissues), the mesoderm (which will make way for the heart and circulatory system), and the endoderm (which will grow into internal organs like the lungs, intestines and bladder).'
            },

            '6': {
                motherText: 'Dear mom, you must have started noticing more changes in your body. Your weight might have increased; though don’t be surprised if you have lost a few kgs due to morning sickness. If you visit your doctor, she will let you know the change in the size of the uterus after performing a pelvis test. Mom, these first few weeks might be a little rough for you. But please know that the symptoms would soon start subsiding and you will feel much better.',
                babyText: 'Mom, I have grown in size. Not much though, just about a quarter of an inch. My heart is beating very fast, about twice as fast as yours and if you have an ultrasound over the next few weeks, you will see a tiny pulsating dot in middle of my body. My eyes and limb buds have also started forming.'
            },
